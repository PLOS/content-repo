...
/**
  ...
  public void createCollectionsAndNewVersionForEachCollTest() throws Exception {
    ...
    verify(spySqlService, times(READER_THREADS)).getCollection(anyString(), anyString(), anyInt(), anyString(), any(UUID.class), eq(Boolean.FALSE)); // reading collections with tags
